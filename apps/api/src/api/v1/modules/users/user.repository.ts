...
export class UserRepository {
    /**
     * Finds a user by its unique identifier, returning the user data or null when no record exists.
     * @param id The unique identifier of the user to retrieve.
     * @returns A promise that resolves to a User object representing the user, or null if no user is found.
     */
    ...
    /**
     * Finds a user by its email address, returning the user data or null when no record exists.
