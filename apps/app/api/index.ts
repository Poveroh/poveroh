...
export type {
    ...
    CreateInsuranceAssetDetails,
    CreateMarketableAssetDetails,
    CreatePrivateDealAssetDetails,
    CreateRealEstateAssetDetails,
