...
import { useIsMobile } from '@poveroh/ui/hooks/use-mobile'
import { cn } from '@poveroh/ui/lib/utils'
import { Button } from '@poveroh/ui/components/button'
import { Input } from '@poveroh/ui/components/input'
import { Separator } from '@poveroh/ui/components/separator'
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@poveroh/ui/components/sheet'
        ...
        <SidebarContext.Provider value={contextValue}>
            <TooltipProvider delayDuration={0}>
                <div
                    ...
                    className={cn(
                        'group/sidebar-wrapper flex space-x-10 w-full has-[[data-variant=inset]]:bg-sidebar',
                        className
                    )}
                    ref={ref}
                    {...props}
...
const Sidebar = React.forwardRef<
    ...
    React.ComponentProps<'div'> & {
        side?: 'left' | 'right'
        variant?: 'sidebar' | 'floating' | 'inset' | 'embedded'
        ...
        >
            ...
            <div
                className={cn(
                    ...
                    'inset-y-0 z-10 hidde w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex',
                    variant === 'floating' || variant === 'inset'
            ...
            >
                <div
                    data-sidebar='sidebar'
                    className='flex h-full w-full flex-col pt-6 pb-6 bg-box-background rounded-md group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow'
                >
                    {children}
                </div>
            </div>
...
const SidebarGroup = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
    return (
        <div
            ref={ref}
            data-sidebar='group'
            className={cn('relative flex w-full min-w-0 flex-col pl-6 pr-6', className)}
            {...props}
        />
    )
})
